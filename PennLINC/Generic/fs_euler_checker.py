...
#subid = 'sub-colornest195'

fs_audit['SubjectID'] = subid

with zipfile.ZipFile('/cbica/projects/RBC/production/CCNP/fmriprep/merge_ds/' + subid + '_freesurfer-20.2.1.zip', 'r') as zip_ref:
    zip_ref.extractall('/cbica/projects/RBC/ccnp_fs/')

l_euler_path = '/cbica/projects/RBC/ccnp_fs/freesurfer/' + subid + '/surf/lh.orig.nofix'
r_euler_path = '/cbica/projects/RBC/ccnp_fs/freesurfer/' + subid + '/surf/rh.orig.nofix'

subprocess.run(["mris_euler_number", "-o", "/cbica/projects/RBC/l_euler.txt", l_euler_path])
subprocess.run(["mris_euler_number", "-o", "/cbica/projects/RBC/r_euler.txt", r_euler_path])
l_euler = open("/cbica/projects/RBC/l_euler.txt","r")
...
r_euler = open("/cbica/projects/RBC/r_euler.txt","r")
...
cort_vol = ''
l_desikan = open("/cbica/projects/RBC/ccnp_fs/freesurfer/" + subid + "/stats/lh.aparc.DKTatlas.stats", "r")
l_cntr = 0
...
r_desikan = open("/cbica/projects/RBC/ccnp_fs/freesurfer/" + subid + "/stats/rh.aparc.DKTatlas.stats", "r")
...
surf_area = ''
l_pial = open("/cbica/projects/RBC/ccnp_fs/freesurfer/" + subid + "/stats/lh.aparc.pial.stats", "r")
r_pial = open("/cbica/projects/RBC/ccnp_fs/freesurfer/" + subid + "/stats/rh.aparc.pial.stats", "r")
...
r_cort_vol = ''
subcort_vol = ''
aseg = open("/cbica/projects/RBC/ccnp_fs/freesurfer/" + subid + "/stats/aseg.stats", "r")
for line in aseg:
