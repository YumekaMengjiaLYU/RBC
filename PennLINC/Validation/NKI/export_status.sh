...
info=$(cat /storage/ttapera/RBC/PennLINC/Validation/NKI/nki_subjects2.txt | head -n $line | tail -n 1)

mkdir -p /storage/ttapera/RBC/data/validation/NKI/$info/bids_directory
...
fw export bids -y --project RBC_NKI --subject $info /storage/ttapera/RBC/data/validation/NKI/$info/bids_directory
export_status=$?
...
rm -rf /storage/ttapera/RBC/data/validation/NKI/$info/bids_directory